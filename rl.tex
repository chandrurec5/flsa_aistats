...
%(The second-order feature stationarity constraint replaces the ``on-policy'' constraint that is often used
to guarantee stability of the TD algorithm.)
...
The conservative stepsize for CAGTD seems to be the price paid for \emph{off-policy} stability. \todoc{This text MUST be updated.}
