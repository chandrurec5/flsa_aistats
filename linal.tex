...
via a similarity transformation that is a symmetric and positive definite matrix.  \todoc{The reverse is also true, right..?}
\end{lemma}
\begin{proof}
...
Now we show a Hurwitz matrix $A$ such that $A+A^\top$ is not positive definite.
In fact, the matrix 
\begin{align*}
A = 
\begin{pmatrix}
