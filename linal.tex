...
$\rhos{P}=\rhod{P} = \lambda(2-\alpha \lambda)$ (the reason for choosing $\alpha_P$ this way will become clear later). \todoc{The claim that for $\lambda_1<\lambda_2$, $\rhos{P} = \lambda_1(2-\alpha \lambda_1)$ was false.}
Thanks to $\EE{N_s}=0$,
\begin{align*}
\EE{\eh^2_{t,1}} =
