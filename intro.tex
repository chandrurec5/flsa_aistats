...
Assuming sufficient regularity of $\{(A_t,b_t)\}_{t\ge 1}$, e.g., independence, or mixing, in addition to bounded moments, if the step-size sequence converges to zero at an appropriate rate,
...
at least for LS problems. Namely, no universal step-size sequence achieves the optimal bound.}
The main result of 
\citet{bach-moulines}, 
...
The question as to what extend our other results can be extended to the Markov noise
