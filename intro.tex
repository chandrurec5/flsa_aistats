...
and user the average $\thh_t\eqdef\frac{1}{t+1}\sum_{s=0}^t \theta_s$ as the output. 
...
For our results that have a negative character there is no loss of generality
