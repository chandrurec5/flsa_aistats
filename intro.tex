...
using the so-called ``second-order feature stationarity condition''. This change is partially made necessary because we consider the i.i.d. case; while it can also be viewed as the ``true'' requirement
