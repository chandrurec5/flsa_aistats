...
Assuming sufficient regularity of $\{(b_t,A_t)\}_{t\ge 1}$, e.g., independence, or mixing, in addition to bounded moments, if the step-size sequence converges to zero at an appropriate rate,
