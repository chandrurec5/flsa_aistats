...
convergence of $\{\theta_t\}_{t\ge 0}$ to $\ts$ can be guaranteed in various senses \cite{bemepri90,borkarbook}. \todoc{cite some papers that do this..}
...
which, up to constant factors, is information-theoretically optimal \cite{nemirovski,agarwal,yudin}. \todoc{This needs a reference.}
...
Hurwitzness and uniformly bounded moments \todoc{Uniform boundedness would be stronger.}
...
that other computationally cheap methods such as those based on matrix sketching idea \cite{woodruff2014sketching}, could be a viable alternative to  CALSA. \todoc{Add some ref! Book..? Widgerson?} 
