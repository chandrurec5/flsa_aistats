...
\fi
We note in passing that the results of \citet{bach} are very similar to this last result, in that, they use weighted-norm with respect to the $A_P$ and the \emph{structured noise} property. \todoc{This is very vague..}
