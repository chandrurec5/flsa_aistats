...
\newcommand{\ROT}{\text{\sc ROT}\xspace}
\newcommand{\ROTa}[1]{\text{\sc ROT}(#1)\xspace}
\newcommand{\SPD}{\mathrm{SPD}\xspace}
\newcommand{\SPDSN}{\mathrm{SPDSN}\xspace}
...
\newcommand{\qfeq}{=_q}
\newcommand{\qfleq}{\leq_q}
\newcommand{\qfgeq}{\geq_q}
%Theorem Definition
