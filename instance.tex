...
Finally, not that one can always take $U$ in the result that leads to the smallest bound. \todoc{Maybe here it is better to allow complex $U$!? This could be a note.}
\begin{comment}
...
\end{restatable}
Note that $\beta_t \ge 1/2$ for $t\ge2 \log(2)/(\alpha \rhos{P})$.
