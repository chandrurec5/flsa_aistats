...
\begin{loglogaxis}
    [
      ...
      every axis title/.style={below left,at={(1,1)},draw=black,fill=white},
...
\caption{\small Experimental results. T, FUN, FN stand for tile coding, Fourier un-normalized and normalized, respectively.  In the bottom left plot, the CAGTD curve is rescaled as shown on the label of the $x$ axis.} 
\label{fig:results}
\end{figure}
